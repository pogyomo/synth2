...
TEST(adsr, normal) {
    ...
    synth2_adsr_release(&adsr);

    TEST_ASSERT_EQUAL(SYNTH2_ADSR_STAGE_R, synth2_adsr_stage(&adsr));
    TEST_ASSERT_DOUBLE_WITHIN(DELTA, 0.5, synth2_adsr_sample(&adsr));
    TEST_ASSERT_EQUAL(SYNTH2_ADSR_STAGE_R, synth2_adsr_stage(&adsr));
    TEST_ASSERT_DOUBLE_WITHIN(DELTA, 0.4, synth2_adsr_sample(&adsr));
    TEST_ASSERT_EQUAL(SYNTH2_ADSR_STAGE_R, synth2_adsr_stage(&adsr));
    ...
    TEST_ASSERT_EQUAL(SYNTH2_ADSR_STAGE_END, synth2_adsr_stage(&adsr));
    TEST_ASSERT_DOUBLE_WITHIN(DELTA, 0.0, synth2_adsr_sample(&adsr));
    TEST_ASSERT_EQUAL(SYNTH2_ADSR_STAGE_END, synth2_adsr_stage(&adsr));
    TEST_ASSERT_DOUBLE_WITHIN(DELTA, 0.0, synth2_adsr_sample(&adsr));
    TEST_ASSERT_EQUAL(SYNTH2_ADSR_STAGE_END, synth2_adsr_stage(&adsr));
...
TEST_GROUP_RUNNER(adsr) {
    ...
    RUN_TEST_CASE(adsr, multiple_release);
    RUN_TEST_CASE(adsr, release_before_s)
}
