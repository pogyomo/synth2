...
typedef enum synth2_param_id {
    ...
    SYNTH2_PARAM_ID_CTRL_VOLUME,
    SYNTH2_PARAM_ID_MIN = SYNTH2_PARAM_ID_OSC1_WAVE,
    SYNTH2_PARAM_ID_MAX = SYNTH2_PARAM_ID_CTRL_VOLUME,
} synth2_param_id_t;
...
typedef struct synth2_params_ctrl {
    uint8_t volume;  // 0..=128
} synth2_params_ctrl_t;
